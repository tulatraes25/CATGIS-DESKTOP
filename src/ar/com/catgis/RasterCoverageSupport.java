...
public final class RasterCoverageSupport {
    ...
    static GridCoverage2D applySidecarMetadataIfPresent(File file, GridCoverage2D coverage) {
    ...
    static String readCrsCodeFromTiffMetadata(File file) {
        if (file == null) {
            return "";
        }
    ...
    static Envelope readEnvelopeFromTiffMetadata(File file, int width, int height) {
