...
extends LineStringEndpointStyle {
    ...
    /* synthetic */ CircleLineStringEndpointStyle(String string, boolean bl, String string2, CircleLineStringEndpointStyle circleLineStringEndpointStyle) {
    ...
    extends CircleLineStringEndpointStyle {
        public End() {
            super(I18N.getString("workbench.ui.renderer.style.CircleLineStringEndpointStyle.end-circle"), false, "CircleEnd.gif", null);
        }
    }
    ...
    extends CircleLineStringEndpointStyle {
        public Start() {
            super(I18N.getString("workbench.ui.renderer.style.CircleLineStringEndpointStyle.start-circle"), true, "CircleStart.gif", null);
        }
    }
}
