...
public class VertexIndexLineSegmentStyle
extends LineStringVertexStyle {
    ...
    extends VertexIndexLineSegmentStyle {
        public VertexIndex() {
            super(I18N.getString("com.vividsolutions.jump.workbench.ui.renderer.style.VertexIndexLineSegmentStyle.vertexes-index"), "VertexIndexDecorator.gif");
        }
    }
}
