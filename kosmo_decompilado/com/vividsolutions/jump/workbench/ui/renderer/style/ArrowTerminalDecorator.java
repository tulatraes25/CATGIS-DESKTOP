...
public class ArrowTerminalDecorator
extends TerminalDecorator {
    ...
    public ArrowTerminalDecorator(String name, boolean start, String iconFile, double finAngle, double finLength, boolean filled) {
    ...
    public double getFinAngle() {
        return this.finAngle;
    }

    public void setFinAngle(double finAngle) {
        this.finAngle = finAngle;
    }
    ...
    extends ArrowTerminalDecorator {
    ...
    extends Feathers {
        public FeathersEnd() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.end-feathers"), false, "FeathersEnd.gif");
        }
    }
    ...
    extends Feathers {
        public FeathersStart() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.start-feathers"), true, "FeathersStart.gif");
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public NarrowSolidEnd() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.end-arrow-solid-narrow"), false, "ArrowEndSolidNarrow.gif", 10.0, 15.0, true);
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public NarrowSolidStart() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.start-arrow-solid-narrow"), true, "ArrowStartSolidNarrow.gif", 10.0, 15.0, true);
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public OpenEnd() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.end-arrow-open"), false, "ArrowEndOpen.gif", 30.0, 10.0, false);
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public OpenStart() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.start-arrow-open"), true, "ArrowStartOpen.gif", 30.0, 10.0, false);
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public SolidEnd() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.end-arrow-solid"), false, "ArrowEndSolid.gif", 30.0, 10.0, true);
        }
    }
    ...
    extends ArrowTerminalDecorator {
        public SolidStart() {
            super(I18N.getString("workbench.ui.renderer.style.ArrowTerminalDecorator.start-arrow-solid"), true, "ArrowStartSolid.gif", 30.0, 10.0, true);
        }
    }
}
