...
public class LineStringSelectionRenderer
extends AbstractSelectionRenderer {
    public static final String CONTENT_ID = "SELECTED_LINESTRINGS";

    public LineStringSelectionRenderer(LayerViewPanel panel, double factor) {
    ...
    protected Collection<Feature> featureToSelectedItemsMap(Layer layer, Envelope envelope) {
        return this.panel.getSelectionManager().getLineStringSelection().getFeatureToSelectedItemCollectionMap(layer, envelope);
    }
}
