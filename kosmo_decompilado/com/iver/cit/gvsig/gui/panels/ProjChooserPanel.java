...
extends CRSSelectPanel {
    ...
    public ProjChooserPanel(IProjection proj, boolean isTask) {
        super(proj);
    ...
    private void initBtnChangeProj() {
        this.getJBtnChangeProj().addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (ProjChooserPanel.this.isTask) {
                    ProjChooserPanel.this.okPressed = false;
                    ...
                    DialogManager.addJDialog(csSelect, I18N.getString("com.iver.cit.gvsig.gui.panels.ProjChooserPanel.spatial-reference-system-selection"));
                    ...
                    DialogManager.addJDialog(trSelect, I18N.getString("com.iver.cit.gvsig.gui.panels.ProjChooserPanel.transformations-selection"));
    ...
    public JLabel getJLblProjName() {
        if (this.jLblProjName == null) {
            this.jLblProjName = new JLabel(String.valueOf(I18N.getString("com.iver.cit.gvsig.gui.panels.ProjChooserPanel.current-projection")) + ":");
        }
