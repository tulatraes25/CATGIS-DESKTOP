...
public class StartFeathersMarkerDecorator
extends FeathersMarkerDecorator {
    public static final String NAME = I18N.getString("es.kosmo.core.renderer.decorators.impl.StartFeathersMarkerDecorator.Starting-feathers");
    public static final Icon ICON = IconLoader.icon("FeathersStart.gif");

    public StartFeathersMarkerDecorator() {
        this(Color.BLACK, 10.0, 30.0, false, 0.0, "pixel");
    }

    public StartFeathersMarkerDecorator(Color color, double size, double sharpness, boolean isFixedRotation, double rotation, String units) {
        this.name = NAME;
        this.icon = ICON;
