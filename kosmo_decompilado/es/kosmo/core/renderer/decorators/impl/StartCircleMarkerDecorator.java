...
public class StartCircleMarkerDecorator
extends CircleMarkerDecorator {
    public static final String NAME = I18N.getString("es.kosmo.core.renderer.decorators.impl.StartCircleMarkerDecorator.Starting-circle");
    public static final Icon ICON = IconLoader.icon("CircleStart.gif");

    public StartCircleMarkerDecorator() {
        this(Color.BLACK, 10.0, false, 2.0, "pixel");
    }

    public StartCircleMarkerDecorator(Color color, double size, boolean filled, double borderSize, String units) {
        this.name = NAME;
        this.icon = ICON;
        this.setColor(color);
        this.setSize(size);
