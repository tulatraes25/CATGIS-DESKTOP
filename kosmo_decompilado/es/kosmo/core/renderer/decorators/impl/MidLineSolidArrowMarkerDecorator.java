...
public class MidLineSolidArrowMarkerDecorator
extends SolidArrowMarkerDecorator {
    public static final String NAME = I18N.getString("es.kosmo.core.renderer.decorators.impl.MidLineSolidArrowMarkerDecorator.Mid-line-solid-arrow");
    public static final Icon ICON = IconLoader.icon("ArrowMidSolid.gif");

    public MidLineSolidArrowMarkerDecorator() {
        this(Color.BLACK, 10.0, 30.0, false, 0.0, "pixel");
    }

    public MidLineSolidArrowMarkerDecorator(Color color, double size, double sharpness, boolean isFixedRotation, double rotation, String units) {
        this.name = NAME;
        this.icon = ICON;
