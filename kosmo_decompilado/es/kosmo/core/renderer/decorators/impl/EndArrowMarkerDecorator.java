...
public class EndArrowMarkerDecorator
extends SolidArrowMarkerDecorator {
    public static final String NAME = I18N.getString("es.kosmo.core.renderer.decorators.impl.EndArrowMarkerDecorator.Ending-arrow");
    public static final Icon ICON = IconLoader.icon("ArrowEndSolid.gif");

    public EndArrowMarkerDecorator() {
        this(Color.BLACK, 10.0, 30.0, false, 0.0, "pixel");
    }

    public EndArrowMarkerDecorator(Color color, double size, double sharpness, boolean isFixedRotation, double rotation, String units) {
        this.name = NAME;
        this.icon = ICON;
