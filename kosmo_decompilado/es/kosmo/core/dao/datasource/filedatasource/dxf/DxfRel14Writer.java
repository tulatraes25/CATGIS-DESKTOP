...
public class DxfRel14Writer
extends AbstractDxfWriter {
    public static final String VERSION = "AC1014";

    public DxfRel14Writer() {
    }

    public DxfRel14Writer(Writer writer) {
        super(writer);
    }

    public DxfRel14Writer(Writer writer, String encoding) {
        super(writer, encoding);
    }

    @Override
    public IDxfWriter newInstance(Writer writer) {
        return new DxfRel14Writer(writer);
    }

    @Override
    public IDxfWriter newInstance(Writer writer, String encoding) {
        return new DxfRel14Writer(writer, encoding);
    }
