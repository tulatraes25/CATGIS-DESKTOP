...
public class OpenKosmoDesktopDocumentsPlugIn
extends AbstractOpenWebSitePlugIn {
    public static final String NAME = I18N.getString("es.kosmo.desktop.plugins.help.OpenKosmoDesktopDocumentsPlugIn.Open-Kosmo-Desktop-user-guides-web-page");
    public static final Icon ICON = DesktopIconLoader.icon("helpUserGuide.png");
    ...
    public URL getURL() throws MalformedURLException {
        ...
        String url = "http://www.opengis.es/index.php?option=com_docman&task=cat_view&gid=19&Itemid=42";
        if (!spanishLocale) {
