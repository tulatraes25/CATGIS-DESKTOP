...
public class ChangeLabelOverlappingPlugIn
extends AbstractPlugIn {
    public static final String NAME = I18N.getString("org.saig.jump.plugin.utils.ChangeLabelVisibility.allow-overlapping-labels");
    ...
    public EnableCheck getCheck() {
        return ChangeLabelOverlappingPlugIn.createEnableCheck(JUMPWorkbench.getFrameInstance().getContext());
    }
    ...
    public boolean execute(PlugInContext context) throws Exception {
        ...
        layer.setOverlapping(!layer.isOverlapping());
    ...
    public static EnableCheck createEnableCheck(final WorkbenchContext workbenchContext) {
        ...
        result.add(new EnableCheck(){
            ...
            public String check(JComponent component) {
                ((JCheckBoxMenuItem)component).setSelected(((Layer)workbenchContext.getLayerNamePanel().getSelectedLayers()[0]).isOverlapping());
                return null;
            }
        });
        result.add(new EnableCheck(){
