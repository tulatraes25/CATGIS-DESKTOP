...
public class CloseTracePlugIn
extends AbstractPlugIn {
    public static final String NAME = I18N.getString("org.saig.jump.plugin.editing.CloseTracePlugIn.Close-trace");
    public static final Icon ICON = GUIUtil.resize(IconLoader.icon("close_trace.png"), 20);
    ...
    public EnableCheck getCheck() {
        return CloseTracePlugIn.createEnableCheck(JUMPWorkbench.getFrameInstance().getContext());
    }
    ...
    public static EnableCheck createEnableCheck(WorkbenchContext workbenchContext) {
        EnableCheck check = new EnableCheck(){
            ...
            public String check(JComponent component) {
                boolean cond = false;
                boolean bl = cond = CloseTracePlugIn.getInProgressCursorTool() != null;
                if (!cond) {
                    return "";
                }
                return null;
    ...
    public boolean execute(PlugInContext context) {
        CloseTracePlugIn.getInProgressCursorTool().closeTrace();
        return true;
    }
