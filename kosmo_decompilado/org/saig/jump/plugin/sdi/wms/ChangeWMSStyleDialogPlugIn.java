...
import es.kosmo.desktop.widgets.sdi.wms.ChangeWMSStyleDialog;
import javax.swing.Icon;
import org.saig.jump.lang.I18N;

public class ChangeWMSStyleDialogPlugIn
extends AbstractPlugIn {
    public static final String NAME = I18N.getString("org.saig.jump.plugin.wms.ChangeWMSStyleDialogPlugIn.name");
    ...
    public boolean execute(PlugInContext context) {
        ...
        if (layers.length > 0) {
            ...
            new ChangeWMSStyleDialog(JUMPWorkbench.getFrameInstance(), true, layer);
        }
        return true;
    }
    ...
    public EnableCheck getCheck() {
        return ChangeWMSStyleDialogPlugIn.createEnableCheck(JUMPWorkbench.getFrameInstance().getContext());
    }
