...
public class TableRecordFieldValuesDialog
extends JDialog {
    ...
    public TableRecordFieldValuesDialog(Frame parentFrame, boolean modal) {
    ...
    private void initComponents() {
        ...
        this.addWindowListener(new WindowAdapter(){
            ...
            public void windowClosing(WindowEvent evt) {
                TableRecordFieldValuesDialog.this.closeDialog();
            }
        });
        ...
        if (this.valueListPanel == null) {
            ...
            this.valueList.addListSelectionListener(new ListSelectionListener(){
                ...
                public void valueChanged(ListSelectionEvent e) {
                    TableRecordFieldValuesDialog.this.jList1_valueChanged(e);
                }
            });
            this.valueList.setCellRenderer(new TableValuesListCellRenderer());
    ...
    private static class TableValuesListCellRenderer
    extends JLabel
    implements ListCellRenderer {
        private static final long serialVersionUID = 1L;

        private TableValuesListCellRenderer() {
        }
