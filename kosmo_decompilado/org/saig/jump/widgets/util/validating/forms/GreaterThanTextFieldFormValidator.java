...
public class GreaterThanTextFieldFormValidator
extends AbstractFormValidator {
    public static final String DEFAULT_MESSAGE = String.valueOf(I18N.getString("org.saig.jump.widgets.util.validating.GreaterThanTextFieldValidator.the-field-value-must-be-greater-than")) + " ";
    private double minimumValue = 0.0;
    private String message = "";
    private boolean obligatorio;

    public GreaterThanTextFieldFormValidator(IStatusForm parent, JTextField c, double minimumValue) {
        super(parent, (JComponent)c, String.valueOf(DEFAULT_MESSAGE) + minimumValue);
        this.minimumValue = minimumValue;
    }

    public GreaterThanTextFieldFormValidator(IStatusForm parent, JTextField c, double minimumValue, String message) {
