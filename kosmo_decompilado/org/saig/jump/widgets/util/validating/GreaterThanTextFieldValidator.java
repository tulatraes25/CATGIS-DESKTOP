...
public class GreaterThanTextFieldValidator
extends AbstractValidator {
    ...
    public GreaterThanTextFieldValidator(JDialog parent, JComponent c, double minimumValue) {
        super(parent, c, String.valueOf(DEFAULT_MESSAGE) + minimumValue);
        this.minimumValue = minimumValue;
    }

    public GreaterThanTextFieldValidator(JDialog parent, JComponent c, String message, double minimumValue) {
