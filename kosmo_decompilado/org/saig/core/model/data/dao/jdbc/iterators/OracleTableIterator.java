...
public class OracleTableIterator
extends JDBCTableIterator {
    public OracleTableIterator(String query, TableDBRecordDataSource dataSource) {
        super(query, dataSource);
    }

    public OracleTableIterator(String query, Filter filter, TableDBRecordDataSource dataSource) {
