...
public class DBControlPanelWithReport
extends JPanel
implements ControlPanel {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(DBControlPanelWithReport.class);
    ...
    private AbstractButton buttonReport;
    public static final String ODS_EXTENSION = "ods";

    public DBControlPanelWithReport() {
        this.initComponents();
    }
        ...
        if (this.table.getSelectionModel() != null) {
            this.table.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
                ...
                public void valueChanged(ListSelectionEvent e) {
                    DBControlPanelWithReport.this.evaluateButtons();
                }
            });
        }
    }
    ...
    private void initComponents() {
        ...
        this.buttonInsert.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.insertButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
        ...
        this.buttonDelete.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.deleteButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
        ...
        this.buttonCommit.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.commitButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
        ...
        this.buttonRollback.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.rollbackButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
        panelOperations.add(this.buttonRollback);
        this.buttonReport.setText("Report");
        this.buttonReport.setPreferredSize(dimension);
        this.buttonReport.setMaximumSize(dimension);
        this.buttonReport.setMinimumSize(dimension);
        this.buttonReport.setEnabled(false);
        this.buttonReport.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.reportButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
        panelOperations.add(this.buttonReport);
        ...
        this.buttonCancel.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                DBControlPanelWithReport.this.cancelButtonActionPerformed(evt);
                DBControlPanelWithReport.this.postEvent();
            }
        });
    ...
    protected void reportButtonActionPerformed(ActionEvent evt) {
        ...
        FeatureSchema fs = this.tablePanel.getSchema();
        List<Object> data = this.tablePanel.getEntityListData();
        try {
        ...
        new AbstractWaitDialog(JUMPWorkbench.getFrameInstance(), I18N.getString("org.saig.core.model.data.widgets.tables.management.control.DBControlPanelWithReport.generating-spreedsheet")){
