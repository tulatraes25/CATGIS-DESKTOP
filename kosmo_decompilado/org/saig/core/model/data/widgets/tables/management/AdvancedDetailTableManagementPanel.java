...
public class AdvancedDetailTableManagementPanel
extends AdvancedTableManagementPanel {
    private static final Logger LOGGER = Logger.getLogger(AdvancedDetailTableManagementPanel.class);
    private AdvancedTableManagementPanel masterPanel;
    private String masterKeyFieldName;
    private Object masterKeyFieldValue;

    public AdvancedDetailTableManagementPanel(String tableName, AdvancedControlPanel control, AdvancedTableManagementPanel masterPanel, String linkField, TableDef tableDef, JInternalFrame parent) throws Exception {
        super(tableName, control, tableDef, parent);
        ...
        ((AdvancedDBDetailControlPanel)control).setMasterKeyFieldName(linkField);
        ...
        masterPanel.getMainTable().addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent evt) {
                AdvancedDetailTableManagementPanel.this.updateData(evt);
                AdvancedDetailTableManagementPanel.this.updateActivation();
            }
    ...
    private void updateData(MouseEvent evt) {
        ...
        ((AdvancedDBDetailControlPanel)this.controlPanel).setMasterKeyFieldValue(this.masterKeyFieldValue);
        this.loadData();
    }
