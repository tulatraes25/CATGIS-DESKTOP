...
public class IntersectsTopologyRelation
extends AbstractTopologyBinaryRelation {
    public static final String ID = "Intersects";
    public static final String NAME = I18N.getString(IntersectsTopologyRelation.class, "intersect");
    ...
    public String getDescription() {
        return I18N.getString(this.getClass(), "this-operator-allows-to-check-that-for-each-element-in-the-source-layer-at-least-one-element-in-the-target-layer-intersects-with-it-an-element-a-intersects-with-another-element-b-if-they-share-at-least-one-common-point");
    }
                ...
                block2 : switch (this.checkStrategy) {
                    case 0: {
                        ...
                        while (true) {
                            ...
                            check = check && !featGem.intersects(candidate.getGeometry());
                            ++cont;
                        }
