...
public class EqualsTopologyRelation
extends AbstractTopologyBinaryRelation {
    public static final String ID = "Equals";
    public static final String NAME = I18N.getString(EqualsTopologyRelation.class, "equals");
    ...
    public String getDescription() {
        return I18N.getString(this.getClass(), "equals-operator-allos-to-check-that-for-each-element-in-the-source-layer-there-are-at-least-one-element-in-the-target-layer-with-the-same-geometry-an-element-a-is-equals-to-another-element-b-if-both-of-them-share-at-least-one-common-point-and-none-of-them-has-any-point-outside-the-other");
    }
                ...
                block2 : switch (this.checkStrategy) {
                    case 0: {
                        ...
                        while (true) {
                            ...
                            check = check && !featGem.equalsExact(candidate.getGeometry());
                            ++cont;
                        }
