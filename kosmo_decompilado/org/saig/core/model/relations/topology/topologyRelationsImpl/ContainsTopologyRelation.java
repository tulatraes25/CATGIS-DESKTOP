...
public class ContainsTopologyRelation
extends AbstractTopologyBinaryRelation {
    public static final String ID = "contains";
    public static final String NAME = I18N.getString(ContainsTopologyRelation.class, "contains-to");
    ...
    public String getDescription() {
        return I18N.getString(this.getClass(), "this-operator-checks-that-each-element-in-source-layer-contains-at-least-one-element-in-target-layer-an-element-a-contains-another-element-b-if-each-point-of-b-is-a-point-of-a-and-they-have-at-least-one-interior-point-in-common");
    }
                ...
                block2 : switch (this.checkStrategy) {
                    case 0: {
                        ...
                        while (true) {
                            ...
                            check = check && !candidate.getGeometry().contains(featGem);
                            ++cont;
                        }
