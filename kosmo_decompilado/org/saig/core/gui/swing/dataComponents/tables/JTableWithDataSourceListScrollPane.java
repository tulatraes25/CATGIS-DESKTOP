...
public class JTableWithDataSourceListScrollPane
extends JScrollPane
implements DataListComponent<Record> {
    ...
    public JTableWithDataSourceListScrollPane(TableDBRecordDataSource table, String field, String keyField, int width, int height) {
        this(table, field, keyField, width, height, null);
    }

    public JTableWithDataSourceListScrollPane(TableDBRecordDataSource table, String field, String keyField, int width, int height, String fieldOrdered) {
        super(22, 31);
        this.table = table;
        this.field = field;
    ...
    public List<Record> getAllValues() {
        ...
        while (i < model.getSize()) {
            ...
            List<Record> records = this.table.getByAttribute(new String[]{this.field}, new Object[]{currentItem}, this.fieldOrdered, this.filter);
            values.add(records.get(0));
            ++i;
        }
        return values;
