...
public class JTablePatternList
extends JList
implements DataListWithPatternComponent<Record> {
    ...
    public JTablePatternList(Table table, String[] fields, String keyField, String fieldOrdered, String pattern) {
        this.table = table;
        this.fields = fields;
