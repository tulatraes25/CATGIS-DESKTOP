...
public class JTablePatternComboBox
extends JComboBox
implements ItemListener,
DataListWithPatternComponent<Record> {
    ...
    public JTablePatternComboBox(Table table, String keyField, String[] fields, String fieldOrdered, Filter filter, String pattern) {
        this.table = table;
        this.fields = fields;
    ...
    public List<Record> getRowsByValues(Object[] values) {
        if (values != null) {
            ...
            return this.table.getByPrimaryKeys(keys.toArray());
        }
        return null;
    }
