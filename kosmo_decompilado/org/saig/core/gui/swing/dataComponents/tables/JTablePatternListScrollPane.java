...
public class JTablePatternListScrollPane
extends JScrollPane
implements DataListWithPatternComponent<Record> {
    ...
    public JTablePatternListScrollPane(Table table, String[] fields, String keyField, int rows, int cols, String fieldOrdered, String pattern) {
        super(22, 31);
        this.table = table;
        this.fields = fields;
