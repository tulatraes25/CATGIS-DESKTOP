...
public class JTableWithDataSourceComboBox
extends JComboBox
implements DataListComponent<Record>,
ItemListener {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(JTableWithDataSourceComboBox.class);
    protected TableRecordDataSource table;
    ...
    public JTableWithDataSourceComboBox(TableRecordDataSource table, String keyField, String fieldToShow) {
        this(table, keyField, fieldToShow, fieldToShow, null);
    }

    public JTableWithDataSourceComboBox(TableRecordDataSource table, String keyField, String fieldToShow, String fieldOrdered) {
        this(table, keyField, fieldToShow, fieldOrdered, null);
    }

    public JTableWithDataSourceComboBox(TableRecordDataSource table, String keyField, String fieldToShow, String fieldOrdered, Filter filter) {
        this.table = table;
    ...
    public void refresh() {
        ...
        TreeSet<Object> recordValues = new TreeSet();
        if (CollectionUtils.isNotEmpty(records)) {
            Object fieldValue;
    ...
    public Record getValue() {
        ...
        if (CollectionUtils.isEmpty(records)) {
            LOGGER.warn((Object)I18N.getMessage("org.saig.core.gui.swing.dataComponents.tables.JTableWithDataSourceComboBox.error-while-recovering-the-associated-value-to-the-field-{0}-and-the-value{1}", new Object[]{this.field, selectedItem}));
            return null;
        }
