...
extends JDBCIterator {
    ...
    public MySQLIterator(String consultaBD, Filter filter, AbstractJDBCDataSource dataSource, List<String> labels) {
        this(consultaBD, filter, dataSource, labels, false);
    }

    public MySQLIterator(String consultaBD, Filter filter, AbstractJDBCDataSource dataSource, List<String> labels, boolean checkFilter) {
