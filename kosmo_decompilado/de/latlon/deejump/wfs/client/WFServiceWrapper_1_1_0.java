...
public class WFServiceWrapper_1_1_0
extends AbstractWFSWrapper {
    private static final Logger LOGGER = Logger.getLogger(WFServiceWrapper_1_1_0.class);

    public WFServiceWrapper_1_1_0(BasicAuthentificationData logins, String wfsURL) throws Exception {
        super(logins, wfsURL);
    }
    ...
    public void initialize() throws Exception {
        ...
        try {
            ...
            LOGGER.info((Object)(String.valueOf(I18N.getString("de.latlon.deejump.wfs.client.WFServiceWrapper_1_1_0.loading-wfs-server-capabilities")) + " - " + capsURL));
            wfsCapsDoc.load(httpget.getResponseBodyAsStream(), "http://www.deegree.org");
        }
        catch (MalformedURLException e) {
            LOGGER.error((Object)I18N.getString("de.latlon.deejump.wfs.client.WFServiceWrapper_1_1_0.invalid-url"), (Throwable)e);
            throw new Exception(e);
        }
        catch (IOException e) {
            LOGGER.error((Object)("IOException when opening: " + this.getCapabilitiesURL()), (Throwable)e);
            throw new Exception(e);
        }
